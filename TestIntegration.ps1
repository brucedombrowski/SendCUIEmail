...
<#
.SYNOPSIS
    Integration test for SendCUIEmail - non-interactive encryption with README generation.
...
try {
    ...
    $fileList = ($encryptedFiles | ForEach-Object { "- ``$_``" }) -join "`n"

    $readme = @"
# CUI - Encrypted Files - Decryption Instructions
